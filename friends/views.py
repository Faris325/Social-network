...
class AddFriend(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if not Friends.objects.filter(
            sender=sender, receiver=receiver, application_status="pending"
...
class FriendAccept(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        Friends.objects.create(
            sender=sender, receiver=receiver, application_status="accepted"
        )

        Friends.objects.filter(
            Q(sender=sender, receiver=receiver, application_status="pending")
            | Q(sender=receiver, receiver=sender, application_status="pending")
        ).delete()
...
class FriendCancellation(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        Friends.objects.filter(
            Q(sender=sender, receiver=receiver, application_status="pending")
            | Q(sender=sender, receiver=receiver, application_status="rejected")
        ).delete()
...
class FriendReject(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        Friends.objects.create(
            sender=sender, receiver=receiver, application_status="rejected"
        )
...
class FriendDelete(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        Friends.objects.filter(
            Q(sender=deleter, receiver=deleted, application_status="accepted")
            | Q(sender=deleted, receiver=deleter, application_status="accepted")
        ).delete()
